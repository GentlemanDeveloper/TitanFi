TitanFi Documentation
=====================

TitanFi is a powerful Python framework for training and deploying autonomous AI agents through adversarial evolutionary reinforcement learning. It enables continuous self-improvement through evolutionary algorithms and robust testing mechanisms.
...
.. code-block:: bash
   ...
   # With LLaMA support
   pip install titanfi[llama]

   # With all features (LLaMA, DeFi tools)
   pip install titanfi[all]

For development installation:

.. code-block:: bash

   git clone https://github.com/HandsOnDevelopers/titanfi.git
   cd titanfi
   pip install -e ".[dev]"
...
Here's a simple example of using TitanFi with Solana DeFi analysis:

.. code-block:: python

   from titanfi import Agent, Evolution, Judge, AdversarialTester
...
TitanFi consists of four main components:
...
TitanFi supports multiple LLM backends:
...
We welcome contributions! Please check our `Contributing Guidelines <https://github.com/HandsOnDevelopers/titanfi/blob/main/CONTRIBUTING.md>`_ for details.

License
-------

This project is licensed under the MIT License - see the `LICENSE <https://github.com/HandsOnDevelopers/titanfi/blob/main/LICENSE>`_ file for details.

Contact
-------

- GitHub: `@HandsOnDevelopers <https://github.com/HandsOnDevelopers>`_
- Twitter: `@TitanFi <https://x.com/TitanFi>`_
- Website: `Titanfi.com <https://Titanfi.com>`_
